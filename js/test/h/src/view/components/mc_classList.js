 ...
 * @Last Modified by: hf
 * @Last Modified time: 2018-08-08 18:59:01
 */

import React from 'react';
import McClassItem from './../components/mc_classItem';

export default class McClassList extends React.Component {
  constructor(props) {
    super(props);
    this.grid = [[]];
  }
