/*
 * @Author: JudyC 
 * @Date: 2018-01-05 10:16:38 
 * @Last Modified by: JudyC
 * @Last Modified time: 2018-03-20 17:06:14
 * 校园事迹内
 */
...
export class StoryIn extends Component {
  constructor(){
    super();
    this.state = {
      data:{},              //头部信息
  ...
  render(){
    return (
      <div className="cjy-si"> 
        <StoryStyleInfo getPicData={this.getPicData} data={this.state.data} getData={this.getData} type="1"/>
